 ...
 */
class Domicilio extends \App\Entity\Domicilio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Domicilio' . "\0" . 'idDomicilio', '' . "\0" . 'App\\Entity\\Domicilio' . "\0" . 'domicilio', '' . "\0" . 'App\\Entity\\Domicilio' . "\0" . 'localidad'];
        }
    ...
    public function getIdDomicilio(): ?int
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdDomicilio();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdDomicilio', []);

        return parent::getIdDomicilio();
    }
     ...
     * {@inheritDoc}
     */
    public function setDomicilio(string $domicilio): \App\Entity\Domicilio
    {
     ...
     * {@inheritDoc}
     */
    public function setLocalidad(?string $localidad): \App\Entity\Domicilio
    {
