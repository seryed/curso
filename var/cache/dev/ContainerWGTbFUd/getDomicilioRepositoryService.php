 ...
 */
class getDomicilioRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DomicilioRepository' shared autowired service.
     *
     * @return \App\Repository\DomicilioRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DomicilioRepository.php';

        return $container->privates['App\\Repository\\DomicilioRepository'] = new \App\Repository\DomicilioRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
